...
const Untitled4 = () => {
  return <View style={_styles.sTytoEje}>
      <View style={_styles.ZsEDAIfc}></View><ImageBackground style={_styles.SHwGxDuA} source={{
    ...
    }} resizeMode="cover"></ImageBackground><Text style={_styles.NcAHZOUj}>Lorem ipsum…</Text></View>;
};

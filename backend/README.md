...
## Project Structure
    ...
    ├── stuidonewapp_dev_38289  # Django project configurations
...
1. Clone this repo and `cd stuidonewapp_dev_38289`
...
2. Clone this repo and `cd stuidonewapp_dev_38289`
